...
char Pilha_Topo()
{
     ...
     if(!Pilha_Vazia())  //primeiro deve-se conferir se a Pilha n�o est� vazia
     {
        Topo->Item;  //Topo aponta uma c�lula com o �ltimo elemento empilhado

        return Topo->Item; ;  //retorna verdadeiro indicando que o �ltimo elemento da Pilha foi retornado (mas n�o desempilhado)
     }
     else //caso a Pilha esteja vazia
     return '\0';  //retorna falso, indicando que n�o foi poss�vel retornar o elemento
}
